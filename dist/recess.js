...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactStyleNormalizer = __webpack_require__(2);
	...
	var _sqwish = __webpack_require__(16);
	...
	var _headings = __webpack_require__(24);
	...
	var _sizes = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function strict_css(css) {
	    ...
	    _lodash2["default"].forEach(rules, function (rule) {
	        ...
	        ruleList[selector] = _lodash2["default"].filter(ruleList[selector], function (decl) {
	            var prop = decl.match(/[^:]+/)[0];

	            // pre-existing properties are not wanted anymore
	            return !_lodash2["default"].some(declarations, function (dec) {
	        ...
	        ruleList[selector] = _lodash2["default"].uniq(ruleList[selector]);
	    });

	    // reset css because we"re gonna recreate the whole shabang.
	    css = "";

	    _lodash2["default"].forOwn(ruleList, function (value, selector) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3Color = __webpack_require__(19);
